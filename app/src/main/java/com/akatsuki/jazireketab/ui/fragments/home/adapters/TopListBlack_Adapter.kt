...
class TopListBlack_Adapter : RecyclerView.Adapter<TopListBlack_Adapter.MyViewHolder>(){
    private lateinit var onItemCLick: OnItemCLick

    inner class MyViewHolder(val binding: ItemTopListsBlackBinding):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemTopListsBlackBinding.inflate(
