package com.akatsuki.jazireketab.ui.fragments.book_details
...
import com.akatsuki.jazireketab.ui.fragments.book_details.adapters.BookList_Adapter
import com.akatsuki.jazireketab.ui.fragments.book_details.adapters.CoomentList_Adapter
...
class BookDetailsFragment : Fragment() {
    ...
    private lateinit var commentListAdapter: CoomentList_Adapter
    private lateinit var booklistAdapter: BookList_Adapter


    private var viewModel: BookDetailsViewModel? = null
    ...
    override fun onCreateView(
        ...
        viewModel = ViewModelProvider(requireActivity())[BookDetailsViewModel::class.java]

        commentListAdapter = CoomentList_Adapter()
        booklistAdapter = BookList_Adapter()
